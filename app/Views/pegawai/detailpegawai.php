...
<div class="profile-detail card-box">
    ...
    <?php if (session('level') == "superadmin") { ?>
        <a href="/pegawai/edit/<?= $detail['nik']; ?>" class="btn btn-primary">Edit</a>
        <a href="/pegawai/hapus/<?= $detail['nik']; ?>" class="btn btn-danger" onclick="return confirm('Anda Yakin ?');">Hapus</a>
    <?php } ?>
